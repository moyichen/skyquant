...
from common import extract_params, read_stage_csv, ROLLING_CSV, AGGREGATE_CSV
...
def main():
    ...
    if df.empty:
        ...
        for (code, strat), group in df.groupby(["stock_code", "strategy"]):
    ...
    agg_df = (pd.DataFrame(aggregate_rows) if aggregate_rows

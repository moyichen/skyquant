...
STRATEGY_DESCRIPTIONS = {
    "maatr_base": "MA + ATR: enter on SMA(fast) > SMA(slow) with ATR/close volatility filter; exit on ATR chandelier trailing stop (ratchet-only), optional fixed take-profit",
